...
public class ErButton extends AppCompatButton {
...
//    private boolean mEnable;
    ...
    public ErButton(Context context) {
        this(context, null);
    }

    public ErButton(Context context, AttributeSet attrs) {
        this(context, attrs, android.support.v7.appcompat.R.attr.buttonStyle);
    }

    public ErButton(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void setup(AttributeSet attrs) {
        ...
        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.ErButton);
        ...
        mNormalTextColor = a.getColor(R.styleable.ErButton_er_normalTextColor, mDefaultNormalTextColor);
        mPressedTextColor = a.getColor(R.styleable.ErButton_er_pressedTextColor, mDefaultPressedTextColor);
        mUnableTextColor = a.getColor(R.styleable.ErButton_er_unableTextColor, mDefaultUnableTextColor);
        setTextColor();

        //set animation duration
        mDuration = a.getInteger(R.styleable.ErButton_er_animationDuration, mDuration);
        mStateBackground.setEnterFadeDuration(mDuration);

        //set background color
        mNormalBackgroundColor = a.getColor(R.styleable.ErButton_er_normalBackgroundColor, 0);
        mPressedBackgroundColor = a.getColor(R.styleable.ErButton_er_pressedBackgroundColor, 0);
        mUnableBackgroundColor = a.getColor(R.styleable.ErButton_er_unableBackgroundColor, 0);
        ...
        //set radius
        mRadius = a.getDimensionPixelSize(R.styleable.ErButton_er_radius, 0);
        mRound = a.getBoolean(R.styleable.ErButton_er_round, false);
        ...
        //set stroke
        mStrokeDashWidth = a.getDimensionPixelSize(R.styleable.ErButton_er_strokeDashWidth, 0);
        mStrokeDashGap = a.getDimensionPixelSize(R.styleable.ErButton_er_strokeDashWidth, 0);
        mNormalStrokeWidth = a.getDimensionPixelSize(R.styleable.ErButton_er_normalStrokeWidth, 0);
        mPressedStrokeWidth = a.getDimensionPixelSize(R.styleable.ErButton_er_pressedStrokeWidth, 0);
        mUnableStrokeWidth = a.getDimensionPixelSize(R.styleable.ErButton_er_unableStrokeWidth, 0);
        mNormalStrokeColor = a.getColor(R.styleable.ErButton_er_normalStrokeColor, 0);
        mPressedStrokeColor = a.getColor(R.styleable.ErButton_er_pressedStrokeColor, 0);
        mUnableStrokeColor = a.getColor(R.styleable.ErButton_er_unableStrokeColor, 0);
        setStroke();
...
//        // set enable status , so can be use to show two status
//        mEnable = a.getBoolean(R.styleable.ErButton_er_enable, true);
//        setEnabled(mEnable);
        a.recycle();
    }
